...
public class TriTitre extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etxt_for_title.setHint("Entrez le titre du quiz:");
	...
	public void creation(View view){
        ...
        intent.putExtra("type", "get.php?TriTitre=" + etxt_for_title.getText().toString());
